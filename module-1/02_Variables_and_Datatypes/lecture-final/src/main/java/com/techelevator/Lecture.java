...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int hoursInWorkingYear = 2080;
		int rate = 15;
		int payPeriodsInYear = 26;
		double n = hoursInWorkingYear * rate * 1.07 / payPeriodsInYear;
