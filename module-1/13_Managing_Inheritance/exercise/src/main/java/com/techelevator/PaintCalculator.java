...
class PaintCalculator {
    ...
    public static void main(String[] args) {
        ...
        // Step One:
        List<Wall> walls = new ArrayList<Wall>(); //this was commented out
        ...
        while (true) {
            ...
            if (userChoice.equals("1")) {
                // Step One:
                Wall newWall = null; //this was commented out
                ...
                if (shapeChoice.equals("1")) {
                    ...
                    // Step Two:
                    newWall = new RectangleWall(name, color, height, length); //this was commented out
                } else if (shapeChoice.equals("2")) {
                    System.out.println("Enter wall side length >>> ");
                    int sideLength = Integer.parseInt(userInput.nextLine());

                    // Step Three:
                    newWall = new SquareWall(name, color, sideLength); //this was commented out
                    ...
                    // Step Four:
                    newWall = new TriangleWall(name, color, height, base); //this was commented out
                }

                // Step Two:
                System.out.println("Added " + newWall + " wall - "
                        + newWall.getArea() + " square feet");
                walls.add(newWall); //these were commented out
