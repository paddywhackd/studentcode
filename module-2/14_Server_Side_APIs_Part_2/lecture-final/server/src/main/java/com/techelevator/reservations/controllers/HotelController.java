...
public class HotelController {
    ...
    @PostMapping(path = "/hotels/{id}/reservations")
    ...
    public void deleteReservation(@PathVariable int hotelId, @PathVariable int reservationId) throws ReservationNotFoundException {
